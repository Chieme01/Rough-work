...
resource "aws_organizations_policy" "scp_sandbox_isolation" {
  ...
  description = "Sandbox Isolation SCP - This denies Sandbox from accessing other accounts and resources, outside of the Sandbox OU"
  ...
  "Statement": [
    {
      ...
      "Condition": {
        "ForAllValues:StringLike": {
          "aws:PrincipalOrgPaths":"${local.constants.org_id}/*/${local.constants.sandbox_ou}/*"
          },
